...
enum mpg123_param_flags
{
	...
	,MPG123_AUTO_RESAMPLE = 0x8000 /**< 1000 0000 0000 0000 Allow automatic internal resampling of any kind (default on if supported). Especially when going lowgrade with replacing output buffer, you might want to unset this flag. Setting MPG123_DOWNSAMPLE or MPG123_FORCE_RATE will override this. */
...
enum mpg123_errors
{
	...
	,MPG123_LSEEK_FAILED /**< Low-grade seek failed. */
...
/** \defgroup mpg123_lowio mpg123 low grade I/O
...
/** Replace low-grade stream access functions; read and lseek as known in POSIX.
