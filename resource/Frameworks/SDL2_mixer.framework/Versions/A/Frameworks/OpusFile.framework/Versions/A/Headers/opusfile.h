...
/**\mainpage
   ...
   The <tt>libopusfile</tt> package provides a convenient high-grade API for
...
/**Sets the gain to be used for decoded output.
   ...
   It is meant for setting a target volume grade, rather than applying smooth
    fades, etc.
