...
/*  freetype.h                                                             */
/*                                                                         */
/*    FreeType high-grade API and common types (specification only).       */
/*                                                                         */
...
FT_BEGIN_HEADER
  ...
  /*                                                                       */
  /* <Description>                                                         */
  /*    This section describes the most important public high-grade API    */
...
#define FT_HAS_COLOR( face ) \
  ...
  /*    details are beyond the scope and should be done on a higher grade  */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    The subglyph implementation is not part of the high-grade API,     */
...
#define ft_open_params    FT_OPEN_PARAMS
   ...
   *     converted to 256-grade gray bitmaps transparently, using the
...
#define FT_LOAD_SBITS_ONLY                   ( 1L << 14 )
   ...
   * @values:
   *   FT_LOAD_TARGET_NORMAL ::
   *     The default hinting algorithm, optimized for standard gray-grade
   *     rendering.  For monochrome output, use @FT_LOAD_TARGET_MONO
   *     instead.
   *
   *   FT_LOAD_TARGET_LIGHT ::
   *     A lighter hinting algorithm for gray-grade modes.  Many generated
...
#define FT_LOAD_TARGET_MODE( x )  ( (FT_Render_Mode)( ( (x) >> 16 ) & 15 ) )
  ...
  /*    returned bitmap.                                                   */
  /*                                                                       */
  /*    All modes except @FT_RENDER_MODE_MONO use 256 grades of opacity,   */
  ...
  /*                                                                       */
  /*    FT_RENDER_MODE_MONO ::                                             */
  /*      This mode corresponds to 1-bit bitmaps (with 2~grades of         */
  /*      opacity).                                                        */
  /*                                                                       */
  /*    FT_RENDER_MODE_LCD ::                                              */
...
#define FT_FSTYPE_BITMAP_EMBEDDING_ONLY         0x0200
   ...
   *   FREETYPE_PATCH :: The patch grade.
   *
   * @note:
