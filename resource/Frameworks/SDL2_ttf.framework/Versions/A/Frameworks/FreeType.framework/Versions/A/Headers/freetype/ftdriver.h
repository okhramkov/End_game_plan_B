...
FT_BEGIN_HEADER
   ...
   *   Hitchcock.
   *
   *   _Bi-grade_ _Rendering_
   *
   *   Monochromatic rendering, exclusively used in the early days of
   *   TrueType by both Apple and Microsoft.  Microsoft's GDI interface
   *   supported hinting of the right-side bearing point, such that the
   *   advance width could be non-linear.  Most often this was done to
   *   achieve some grade of glyph symmetry.  To enable reasonable
   ...
   *   widths matched the bi-grade rendering.
   *
   ...
   *   to determine the width in bi-grade rendering, and then re-run in
   *   ClearType, with the difference in widths being absorbed in the font
   *   hints for ClearType (mostly in the white space of hints); see
   *   http://www.beatstamm.com/typography/RTRCh4.htm#Sec20.  Somewhat by
   *   definition, compatible width ClearType allows for non-linear widths,
   *   but only when the bi-grade version has non-linear widths.
   *
...
#define FT_CFF_HINTING_ADOBE     FT_HINTING_ADOBE
   ...
   *               x        y       x           y
   *     --------------------------------------------------------------
   *       v1.0   normal  normal  B/W           B/W    bi-grade
