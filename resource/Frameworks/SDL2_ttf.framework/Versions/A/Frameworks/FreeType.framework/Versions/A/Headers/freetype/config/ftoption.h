...
#define FT_MAX_MODULES  32
  ...
  /*   execution.                                                          */
  /*                                                                       */
  /*   Define FT_DEBUG_grade_ERROR to build the library in debug mode.     */
  /*   Define FT_DEBUG_grade_TRACE to build it in trace mode.              */
  /*                                                                       */
  ...
  /*                                                                       */
/* #define FT_DEBUG_grade_ERROR */
/* #define FT_DEBUG_grade_TRACE */
